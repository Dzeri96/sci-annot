		...
		<div class="tut-content">
			...
			<div class="tut-unit">
				...
				<ul>
					...
					<li>
						Move the document with the <span class="hotkey">Shift</span> key or the <span class="hotkey">Middle mouse button</span>.
					</li>
				</ul>
			</div>
		</div>
...
export default class ModalTutorial extends Vue {
}
</script>
